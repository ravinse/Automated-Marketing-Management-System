...
const handleSubmit = async e => {
  ...
  formDataToSend.append('selectedFilters', JSON.stringify(formData.selectedFilters));
  formDataToSend.append('customerSegment', formData.customerSegment);
  formDataToSend.append('emailSubject', formData.emailSubject);
  formDataToSend.append('emailContent', formData.emailContent);
  formDataToSend.append('smsContent', formData.smsContent);
...
const handleSaveDraft = async () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-8">
      <div className="max-w-6xl mx-auto bg-white/80 backdrop-blur-sm rounded-xl shadow-xl p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4">
          ...
          <button type="button" onClick={() => handleSaveDraft()} className="px-4 py-2 text-blue-600 bg-blue-50 rounded hover:bg-blue-100">Save as Draft</button>
